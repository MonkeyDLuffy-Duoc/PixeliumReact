...
export const Cart = () => {
    ...
    // URL base de las imágenes (Debe coincidir con la configuración de tu backend)
                                    ...
                                    <div key={item.id} className="card bg-dark text-white mb-3 shadow-sm">
                                        <div className="row g-0">
                                            <div className="col-md-3 d-flex align-items-center justify-content-center">
                                                <img
                                                    // MODIFICACIÓN CLAVE: CONSTRUIR LA URL
                                                    src={`${IMAGE_URL}${item.imageSrc}`} 
                                                    className="img-fluid rounded-start p-3"
                                                    alt={item.title}
                                                    style={{ maxHeight: "150px", objectFit: "contain" }}
                                                    // Añadir manejo de error por si la imagen no se encuentra
                                                    onError={(e) => {
